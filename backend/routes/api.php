...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // User-specific article features (protected)
    Route::post('/articles/{article}/save', SaveArticleController::class)->whereNumber('article');
    Route::delete('/articles/{article}/save', UnsaveArticleController::class)->whereNumber('article');
    Route::get('/articles/saved', GetSavedArticlesController::class);
